  ...
  return (
    <main className="min-h-screen pt-16">
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
        <div className="mb-8">
          <span className="eyebrow text-mint">Private invitation</span>
          <h1 className="mt-3 font-display text-4xl font-semibold">
            Recommend working with Venkat.
          </h1>
          <p className="mt-4 max-w-2xl text-dim">
            Be specific about the work you observed. Your work email is stored privately
            for verification and is never displayed.
          </p>
        </div>
        ...
        <form onSubmit={submit} className="panel space-y-4 p-6 sm:p-8">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <input required type="email" className={inputClass} maxLength={254} placeholder="Work email (private)" value={form.workEmail} onChange={(e) => update("workEmail", e.target.value)} />
          </div>
          ...
          <div className="flex items-center gap-2 text-xs text-faint">
            <FiShield /> Invite, identity, consent, and manual review are recorded.
          </div>
